...
w("Con 1.000 € el MOQ coreano normal (1.000 cajas, 3.000–4.500 €) no entra. Las tres vías realistas, de más barata a más «marca»:\n")
...
w("|---|---:|---:|")
w("| Parches | 8 × 0,18 $ = 1,44 $ ≈ 1,32 € | 1,5 hojas × 0,45 $ ≈ 0,62 € |")
w("| Pouch / bolsa | 0,05 € | 0,03 € |")
w("| Caja + etiqueta + tarjeta | 0,45 € | 0,45 € |")
w("| Courier + aduana (prorrateado, lote de 200 cajas) | 0,55 € | 0,40 € |")
w("| Merma y muestras (10 %) | 0,25 € | 0,15 € |")
w(f"| **Total** | **≈ {f(COST['nariz_cn'])} €** | **≈ {f(COST['granos'])} €** |")
w("")
w("Con Corea (vía B) la caja de nariz sale a ≈ 4,80 €; sigue siendo rentable pero recorta 1,6 € por caja de contribución. Recomendación: **vía A para el test de 90 días, vía B (o coreano con troquel propio) para la primera reposición grande**, cuando los anuncios ya estén validados y el claim *Made in Korea* se pueda explotar en la creatividad.\n")
...
w("|---|---:|---|")
rows=[("Muestras de 2 proveedores + courier",60,"Imprescindible: no se fabrica sin comparar con Vue"),("Lote piloto: 1.400 parches de nariz (≈ 170 cajas) + 100 hojas de puntos (≈ 65 cajas de granos)",330,"Alibaba, Trade Assurance, courier incluido"),("Cajas kraft, etiquetas, tarjetas, sobres acolchados (250 uds)",130,"Etiqueta impresa, no caja impresa"),("1 caja de Vue + 1 de Hero como referencia",35,"Benchmark físico y atrezo para anuncios comparativos"),("Anuncios mes 0 (test de 10 creatividades, 15 días × 15 €)",225,"Meta, una campaña, ver sección 8"),("Dominio .es + Packlink PRO + imprevistos",70,"Web, Stripe, Resend y WhatsApp ya están; sin cuotas"),("Reserva",150,"Para duplicar el primer anuncio que venda")]
for a,b,c in rows: w(f"| {a} | {b} | {c} |")
w(f"| **Total** | **{sum(r[1] for r in rows)}** | |")
w("")
w("Stock inicial: ≈ 170 cajas de nariz y 65 de granos. Vendido en packs de 2, son 85–110 pedidos, es decir, **2.500–3.000 € de ventas** con un coste de producto de 460 €. La primera reposición (1.000 cajas, ya con caja impresa) se paga con eso.\n")
