...
(async()=>{
  ...
  await p.pdf({path:__dirname+'/'+base+'_body.pdf',format:'A4',printBackground:true,preferCSSPageSize:true,displayHeaderFooter:true,
    headerTemplate:'<div style="width:100%;font-family:Inter,sans-serif;font-size:7pt;color:#8a8579;padding:0 15mm;display:flex;justify-content:space-between;letter-spacing:.12em;text-transform:uppercase"><span>NOCTA</span><span>'+sub+' · v1.0</span></div>',
